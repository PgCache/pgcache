...
pub struct MetricsSnapshot {
    ...
    /// Writes folded into per-connection read-after-write logs (PGC-124).
...
pub fn metrics_delta(before: &MetricsSnapshot, after: &MetricsSnapshot) -> MetricsSnapshot {
    MetricsSnapshot {
        ...
        raw_serve_disjoint_insert: after.raw_serve_disjoint_insert
            - before.raw_serve_disjoint_insert,
        raw_serve_disjoint_delete: after.raw_serve_disjoint_delete
